...
* **Standardizare design Confluence**: Aplica un layout tabelar curat (design oficial Atlassian) si limiteaza automat vizibilitatea graficelor in macro-ul de cuprins pentru a mentine o documentatie usor de citit.
